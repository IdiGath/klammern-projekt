...
/**
 * Die Klasse, welche die Runde einer Partie darstellt. Jede Runde besteht aus mehreren Phasen. Die jeweilige Phase
 * wird mit dem Interfache Phase abgebildet. Die Phasenlogik soll sich im Laufe des Spiels ändern, ohne, dass
 * Logikanpassungen in dieser Klasse. Da eine Partie in mehreren Runden gespielt wird, sollen sie immer neu erzeugt
 * werden. Als Folge soll diese Klasse niemals als {@code @Service} dargestellt werden.
 *
...
public class Runde {
    ...
    /**
     * Erzeugt eine neue Instanz der Runde. Die Methode übernimmt den jeweiligen Spieler, wer als Beginner der Runde
     * diesen soll. Der Beginner wird nach der Programmlogik außerhalb der Runde ermittelt.
     *
    ...
    /**
     * Gibt die aktuelle Trumpfkarte zurück. Diese Karte dient auch für die Bestimmung der Trumpffarbe im Laufe des
     * Spieles.
     *
     * @return Trumpfkarte
     */
    ...
    /**
     * Nimmt einen Zug entgegen und verarbeitet ihn gemäß der Phasenlogik.
     * Nach jedem Zug kommt eine Abfrage zu der nächsten Phase für die zukünftigen Züge.
     *
