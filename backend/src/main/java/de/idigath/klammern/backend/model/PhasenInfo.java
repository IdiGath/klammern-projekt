...
/**
 * Ein Record für den Datentransfer zwischen den Phasen. In diesem Record übergibt eine Phase der
 * anderen Informationen über den jeweiligen Beginner, den Stand in der Runde, das benutzte
 * Spieldeck, sowie die Karten der beiden Spielern.
 *
