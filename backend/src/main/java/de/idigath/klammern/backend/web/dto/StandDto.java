...
/**
 * Das DTO repräsentiert den aktuellen Stand in der Partie. Das Objekt beinhaltet sowohl den
 * aktuellen Stand der Runde, als auch der Stand der Partie ink. Historie.
 *
...
public class StandDto {
  ...
  /**
   * Fügt eine Map der Historie hinzu. Der Map-Eintag soll gleiche Keys wie das StandDto-Objekt
   * beinhalten.
   *
