...
class ZugMapperTest {
    ...
    void mapDtoToZug_jeweilsEineKarte_ok() {
        ...
        ZugbestandDto spielerZugbestandDto = new ZugbestandDto(Spieler.SPIELER.getName(), List.of(dameHerzDto));
        KarteDto koenigHerzDto = new KarteDto(Farbe.HERZ.getName(), Wert.KOENIG.getName());
        ZugbestandDto gegnerZugbestandDto = new ZugbestandDto(Spieler.GEGNER.getName(), List.of(koenigHerzDto));
        ...
        assertThat(result.getDeckerKarten().getFirst().wert().getName()).isEqualTo(zugDto.getDeckerKarten().getFirst().wert());
        assertThat(result.getDeckerKarten().getFirst().farbe().getName()).isEqualTo(zugDto.getDeckerKarten().getFirst().farbe());
        assertThat(result.getBeginnerKarten()).hasSameSizeAs(zugDto.getBeginnerKarten());
        assertThat(result.getBeginnerKarten().getFirst().wert().getName()).isEqualTo(zugDto.getBeginnerKarten().getFirst().wert());
        assertThat(result.getBeginnerKarten().getFirst().farbe().getName()).isEqualTo(zugDto.getBeginnerKarten().getFirst().farbe());
    }
    ...
    void mapDtoToZug_kartenKombinationen_ok() {
        ...
        ZugbestandDto spielerZugbestandDto = new ZugbestandDto(Spieler.SPIELER.getName(), List.of(damePikDto,
                koenigPikDto, assPikDto));
        ...
        ZugbestandDto gegnerZugbestandDto = new ZugbestandDto(Spieler.GEGNER.getName(), List.of(siebenKaroDto,
                achtKaroDto, neunKaroDto));
        ZugDto zugDto = new ZugDto(spielerZugbestandDto, gegnerZugbestandDto);
